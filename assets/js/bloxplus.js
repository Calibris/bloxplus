...
for (key in faq) {
    if ((key - 1) % 2) {
        $('#faq-box .first ul').append('<li style="padding-bottom: 10px; height: 125px;"><b>' + faq[key].title + '</b> ' + faq[key].body + '</li>');
    } else {
        $('#faq-box .second ul').append('<li style="padding-bottom: 10px; height: 125px;"><b>' + faq[key].title + '</b> ' + faq[key].body + '</li>');
    }
}

for (key in features) {
    if (key % 2) {
        $('#features-box .first ul').append('<li style="padding-bottom: 10px; height: 125px;"><b>' + features[key].title + ':</b> ' + features[key].body + '</li>');
    } else {
        $('#features-box .second ul').append('<li style="padding-bottom: 10px; height: 125px;"><b>' + features[key].title + ':</b> ' + features[key].body + '</li>');
    }
}
